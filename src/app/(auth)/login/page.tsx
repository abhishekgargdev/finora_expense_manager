  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
        <div
          className="hidden md:flex flex-col items-start justify-center p-8 rounded-xl text-white"
        ...
        <motion.div className="card p-8" variants={fadeInUp} initial="hidden" animate="show">
          ...
          <form className="mt-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <input
              {...register("email")}
              className="mt-1 w-full px-3 py-2 rounded-md border border-border bg-transparent"
            />
            ...
            <button
              type="submit"
              className="mt-6 w-full inline-flex items-center justify-center px-4 py-2 bg-primary text-white rounded-md"
            >
